...
## Usage
For detailed usage of REMAP, please check the tutorial for mouse brain analysis: [single slice analysis](Examples/mouse_hd.ipynb) and [multiple captures analysis](Examples/mouse_hd_multi.ipynb).