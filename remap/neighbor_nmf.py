...
def find_neighbors(loc_pred, spatial, neighbor_radius = [40, 80, 120], ct_key = 'Cluster'):
    """
    ...
    # Prepare AnnData
    ct_pred = make_celltype_mat(loc_pred[ct_key])
...
def nmf_main(loc_pred, spatial, path, colors, ct_key = 'Cluster', neighbor_radius = [40, 80, 120], ct_interest = None, num_factor = 6, random_state=123):
    ...
    neighbor_khop_pred_all = find_neighbors(loc_pred, spatial = spatial, neighbor_radius = neighbor_radius, ct_key = ct_key)
